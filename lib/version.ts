// Version visible de la aplicacion. Se muestra en el panel admin, debajo de
// "Cerrar sesion", para saber que build esta corriendo en cada entorno.
//
...
export const APP_VERSION_DATE = '2026-08-29'
