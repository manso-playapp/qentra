    ...
    <section className="rounded-[24px] border border-sky-300/60 bg-slate-950 p-4 text-white shadow-[0_18px_40px_rgba(2,8,23,0.32)]">
      <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-sky-200">Escáner móvil</p>
          ...
          <p className="mt-1 text-xs leading-5 text-sky-100/80">
            Escaneá este código con el celular de control. Iniciá sesión con una cuenta autorizada para recepción.
          </p>
